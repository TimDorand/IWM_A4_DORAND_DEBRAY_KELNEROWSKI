<template>
                                    ...
                                    <div class="comment column is-6" v-for="(tag, tagkey) in tagsList" v-if="tag.category === 'main'">
                                        <div class="comment-header-right">
                                            <fieldset class="rating">
                                                <input type="radio" :id="tagkey+'_star5'" :name="'rating_'+(tagkey+1)" value="5">
                                                <label class="full" :for="tagkey+'_star5'" title="Awesome - 5 stars"></label>
                                                <input type="radio" :id="tagkey+'_star4half'" :name="'rating_'+(tagkey+1)" value="4.5">
                                                <label class="half" :for="tagkey+'_star4half'" title="Pretty good - 4.5 stars"></label>
                                                <input type="radio" :id="tagkey+'_star4'" :name="'rating_'+(tagkey+1)" value="4">
                                                <label class="full" :for="tagkey+'_star4'" title="Pretty good - 4 stars"></label>
                                                <input type="radio" :id="tagkey+'_star3half'" :name="'rating_'+(tagkey+1)" value="3.5">
                                                <label class="half" :for="tagkey+'_star3half'" title="Meh - 3.5 stars"></label>
                                                <input type="radio" :id="tagkey+'_star3'" :name="'rating_'+(tagkey+1)" value="3">
                                                <label class="full" :for="tagkey+'_star3'" title="Meh - 3 stars"></label>
                                                <input type="radio" :id="tagkey+'_star2half'" :name="'rating_'+(tagkey+1)" value="2.5">
                                                <label class="half" :for="tagkey+'_star2half'" title="Kinda bad - 2.5 stars"></label>
                                                <input type="radio" :id="tagkey+'_star2'" :name="'rating_'+(tagkey+1)" value="2">
                                                <label class="full" :for="tagkey+'_star2'" title="Kinda bad - 2 stars"></label>
                                                <input type="radio" :id="tagkey+'_star1half'" :name="'rating_'+(tagkey+1)" value="1.5">
                                                <label class="half" :for="tagkey+'_star1half'" title="Meh - 1.5 stars"></label>
                                                <input type="radio" :id="tagkey+'_star1'" :name="'rating_'+(tagkey+1)" value="1">
                                                <label class="full" :for="tagkey+'_star1'" title="Sucks big time - 1 star"></label>
                                                <input type="radio" :id="tagkey+'_starhalf'" :name="'rating_'+(tagkey+1)" value="0.5">
                                                <label class="half" :for="tagkey+'_starhalf'" title="Sucks big time - 0.5 stars"></label>
    ...
    -->
                                            ...
                                            <p style="padding-top:8px">
                                                <span class="tag is-rounded">{{ rest.rate[tag.id] }}</span> {{ tag.name }}
                                            </p></div>
                                    </div>
